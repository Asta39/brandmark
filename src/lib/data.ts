...
export const products: Product[] = [
  ...
  },
  {
    ...
    metaTitle: "Customized Flags Nairobi | Brandmark Print Media",
    name: "Customized Flag",
    category: "Outdoor Advertising",
    price: null,
    description: "Custom rectangular flag on a pole and stand — sized and branded to your specification.",
    longDescription:
      "A rectangular flag on a pole and weighted stand, made to your size and branding. Unlike our teardrop, feather and telescopic banners, this is a straightforward rectangular flag format — a flexible option when you need a simple, classic flag shape rather than a curved silhouette. Pricing depends on size, fabric and finishing, so send us your specification for an exact quote.",
    icon: "megaphone",
    images: ["/images/products/customized-flag.jpg"],
    specs: [
      { label: "Sizing", value: "Made to your specification" },
      { label: "Material", value: "Knitted polyester, single or double-sided print" },
      { label: "Base", value: "Pole and weighted stand" },
      { label: "Turnaround", value: "3–5 working days" },
      { label: "Minimum order", value: "1 piece" },
    ],
    options: ["Custom size on request", "Single or double-sided print"],
    useCases: [
      "Storefront and reception entrances",
      "Corporate and government offices",
      "Event and ceremony branding",
      "Boardroom and lobby display",
    ],
    faqs: [
      { q: "Why is there no fixed price?", a: "Rectangular flags are made to your chosen size and fabric, so pricing depends on your specification — send us your details for a quote." },
      { q: "How is this different from your teardrop or feather flags?", a: "Those have curved, shaped silhouettes; this is a classic straight rectangular flag on a pole, more traditional in look." },
      { q: "Can I get a matching set for multiple locations?", a: "Yes, bulk pricing applies for matching sets across multiple sites — tell us your quantity." },
    ],
    relatedServiceSlug: "advertising-materials",
  },
  {
    slug: "customized-leso",
    metaTitle: "Customized Lesos Nairobi | Branded Kanga — Brandmark Print Media",
    name: "Customized Leso",
    category: "Promotional Materials",
    price: null,
    description: "Branded leso/kanga fabric wrap, custom printed with your colours and pattern.",
    longDescription:
      "A leso (kanga) is a vibrant printed cotton wrap deeply woven into East African culture — a distinctive, locally-loved format for corporate gifting, cultural events and community outreach that most branded merchandise can't match. We print your pattern and colours onto quality cotton fabric. Pricing depends on quantity and design complexity, so send us your details for a quote.",
    icon: "bag",
    images: ["/images/products/leso.jpg"],
    specs: [
      { label: "Material", value: "Printed cotton fabric" },
      { label: "Sizing", value: "Standard leso size, custom sizes on request" },
      { label: "Turnaround", value: "7–10 working days" },
      { label: "Minimum order", value: "Bulk order recommended — ask for pricing tiers" },
    ],
    options: ["Custom colours and pattern", "Bulk order pricing tiers"],
    useCases: [
      "Corporate gifting with local cultural relevance",
      "Community outreach and CSR events",
      "Cultural celebrations and ceremonies",
      "Retail and market merchandise",
    ],
    faqs: [
      { q: "Why is there no fixed price?", a: "Pricing depends on quantity and how complex your pattern is — send us your design idea and quantity for a quote." },
      { q: "Can I supply my own pattern design?", a: "Yes, send your design or colour scheme and we'll produce a proof before the full print run." },
      { q: "What's the minimum order?", a: "Lesos are best ordered in bulk for cost efficiency — ask us for pricing at your target quantity." },
    ],
  },
  {
    slug: "a5-desk-flag",
    metaTitle: "A5 Desk Flags Nairobi | Brandmark Print Media",
    name: "A5 Desk Flag",
    category: "Promotional Materials",
    price: null,
    description: "Small A5-size desk flag on a mini stand — single or double-sided, with or without frills.",
    longDescription:
      "A compact A5-size flag on a desktop stand, perfect for reception counters, boardroom tables and exhibition desks. Available single or double-sided, and with a decorative frilled edge for a more formal presentation. Pricing depends on finish and quantity, so send us your requirements for a quote.",
    icon: "banner",
    images: ["/images/products/a5-flag.jpg"],
    specs: [
      { label: "Size", value: "A5" },
      { label: "Finish", value: "Single-sided, double-sided, or with frilled edge" },
      { label: "Base", value: "Miniature desktop stand" },
      { label: "Turnaround", value: "3–5 working days" },
      { label: "Minimum order", value: "1 piece, bulk pricing available" },
    ],
    options: ["Single or double-sided print", "Plain or frilled edge"],
    useCases: [
      "Reception and front-desk branding",
      "Boardroom table settings",
      "Exhibition and registration desks",
      "Corporate gifting sets",
    ],
    faqs: [
      { q: "Why is there no fixed price?", a: "Pricing varies by finish (plain vs frilled) and quantity — send us your requirements for a quote." },
      { q: "Can I order a set for a boardroom table?", a: "Yes, matching sets are a popular order — tell us how many you need." },
      { q: "What's the difference between single and double-sided?", a: "Single-sided prints on one face only; double-sided repeats the design on both sides so it reads correctly from either direction." },
    ],
    relatedServiceSlug: "advertising-materials",
  },
  {
    slug: "flag-stand",
    metaTitle: "Flag Stands Nairobi | Single, Double & Triple — Brandmark Print Media",
    name: "Flag Stand",
    category: "Outdoor Advertising",
    price: null,
    description: "Flag pole stand base — single, double or triple pole configurations.",
    longDescription:
      "A weighted flag stand base that holds one, two or three flag poles at once — useful for displaying multiple flags together at an entrance, stage or reception area. Sold as the stand and pole hardware; flags are quoted separately or as a bundle. Pricing depends on configuration, so send us your requirements for a quote.",
    icon: "megaphone",
    images: ["/images/products/flag-stand.jpg"],
    specs: [
      { label: "Configuration", value: "Single, double or triple pole" },
      { label: "Material", value: "Chrome-finished steel poles, weighted base" },
      { label: "Turnaround", value: "3–5 working days" },
      { label: "Minimum order", value: "1 unit" },
    ],
    options: ["Single, double or triple pole", "Bundle with flags for a full set"],
    useCases: [
      "Building entrances and lobbies",
      "Stage and podium settings",
      "Government and corporate offices",
      "Multi-flag ceremonial displays",
    ],
    faqs: [
      { q: "Why is there no fixed price?", a: "Pricing depends on how many poles you need (single, double or triple) — send us your requirement for a quote." },
      { q: "Do flags come included with the stand?", a: "The stand and poles are quoted separately from flags, but we can bundle both together — ask when you order." },
      { q: "Is it suitable for indoor use only?", a: "It's built primarily for indoor and sheltered outdoor use; for open outdoor display, our teardrop or telescopic banner stands handle wind better." },
    ],
    relatedServiceSlug: "advertising-materials",
  },
];
